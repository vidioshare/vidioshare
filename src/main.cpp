...
const string strMessageMagic = "Vidio Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Vidio", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Sun, 21 Sep 2014 16:30:25 GMT";
        CTransaction txNew;
        txNew.nTime = 1411317027;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1411317027;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1594393;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x11dc38362a7d49fb9c429106d5afe68a5f916ed7107d56007607c00150241792"));
        block.print();
